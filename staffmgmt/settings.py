...
# # WSGI
# # ---------------------------
# WSGI_APPLICATION = 'staffmgmt.wsgi.application'
...
# DATABASES = {
#     'default': {
#         'ENGINE': 'django.db.backends.sqlite3',  # simple DB for development
...
TEMPLATES = [
    {
        ...
        'APP_DIRS': True,  # important for {% load static %} to work
        'OPTIONS': {
            'context_processors': [
                'django.template.context_processors.debug',
                'django.template.context_processors.request',
